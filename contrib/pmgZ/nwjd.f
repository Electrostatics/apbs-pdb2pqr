...
c* @version $Id: nwjd.f 868 2006-04-05 18:32:05Z todd_dolinsky $
c* @attention
c* @verbatim
c*
...
c*    *** do in one step ***
     ...
     5      itmax,iters,errtol,omega,iresid,iadjoint)
         ...
         call vnmprt(2,'% NWJAC: invalid stencil type given...',38)
      endif
c*
c*    *** return and end ***
      return
...
c*    *** messages ***
      if (ifail_tol .gt. 0) then
         call vnmpri(2,'% NWJAC: 1d newton tolerance failures:    ',
     2      42, ifail_tol)
      endif
c*
c*    *** return and end ***
