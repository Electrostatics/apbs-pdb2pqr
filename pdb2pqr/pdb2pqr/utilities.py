...
from . import psize
from .config import FILTER_WARNINGS, FILTER_WARNINGS_LIMIT, FORCE_FIELDS
from .config import SMALL_NUMBER, DIHEDRAL_WTF, TITLE_FORMAT_STRING, VERSION
...
def print_pqr_header_cif(atomlist, reslist, charge, force_field,
    ...
    header += "1\n"
    header += ";\n"
    header += "PQR file generated by PDB2PQR\n"
    header += TITLE_FORMAT_STRING.format(version=VERSION) + "\n"
    header += "\n"
...
def print_pqr_header(pdblist, atomlist, reslist, charge, force_field, ph_calc_method,
    ...
    header = header + "REMARK   1 %s" % TITLE_FORMAT_STRING.format(version=VERSION)
