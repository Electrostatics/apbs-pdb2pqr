function build_page(jobid){
	...
	//change surface
    var b = 
    "<table border='0'><tr><td width='25%' valign='top'><font style='color:white; font-size:12pt'>Surface: </font></td><td colspan='2'> &nbsp;<font style='color: black; font-size: 8pt; font-style: italic'>Click to change</font><br>" +
...
"<select class='styled-select' id='selected_vis' onchange='set_vis()'>"+
...
"    </select></td></tr>" 
+ "<tr><td>&nbsp;</td><td height='45'><div class='inner'><ul class='button-group round' class='leftbutton'><input type='button' button class='button-backbone pure-button' style='width: 125px; height: 40px; color: black' value='On' onclick='on_surface()'></button></input>" +
"    <input type='button' button class='button-backbone pure-button' style='width: 125px; height: 40px; color: black' input type='button' value='Off' onclick='glviewer.removeSurface(surf)'></button></input></ul></div></td></tr>" +
"<tr><td>&nbsp;</td><td height='45'><div class='inner'><ul class='button-group round' class='rightbutton'><input type='button' button class='button-labela pure-button' style='width: 125px; height: 40px; color: black; font-size: 10pt' value='Translucent' onclick='update_surface(2)'></button></input>" +
"    <input type='button' button class='button-unlabela pure-button' style='width: 125px; height: 40px; color: black' input type='button' value='Opaque' onclick='update_surface(3)'></button></input></ul></div>" + "</td></tr></table>"  

 //change color scheme 
 var c =   
"<table border='0'><tr><td width='25%' valign='top'><font style='color:white; font-size:12pt'>Scheme: </font></td><td><font style='color: black; font-size: 8pt; font-style: italic'>Click to change</font><br><select class='styled-select' id='selected_scheme' onchange='update_surface(0)'>" +
...
var i = 
"<table border='0'><tr><td width='25%' valign='top'><font style='color:white; font-size:12pt'>Visualization: </font></td><td><div class='inner'><select class='styled-select' id='selected_vis' onchange='set_vis())'>"+
"        <option style='color: black;' value='stick'>Stick </option>"+
"        <option style='color: black;' value='line'>Line </option>"+
"        <option style='color: black;' value='cross'>Cross </option>"+
"        <option style='color: black;' value='sphere'>Sphere </option>"+
...
//change min isoval
var d =
" <table class='main' border='0'><tr><td style='color: white; font-size: 12pt'><br>Minimum: &nbsp;</td> " +
...
//change max isoval
var e =
" <table class='main'><tr><td width='38%' style='color: white; font-size: 12pt'>Maximum: &nbsp;</td> " +
