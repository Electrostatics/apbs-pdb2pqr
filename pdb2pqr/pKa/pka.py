...
class pKaRoutines:
    ...
    """
    def __init__(self, protein, routines, forcefield):
        """
    ...
    def getAPBSPotentials(self):
        ...
        #
        # Todd: The pka.in file needs to be created automaticall. I'm sure you
        # know how to do that better than I do
        #
        potentials = runAPBS(protein, "pka.in")
        #
        #for atomname in atomnames:
        #    atomlist.append(residue.getAtom(atomname))
        #
                ...
                for group in self.pKagroups:
                    if resname == group:
                        ...
                        for hydrodef in self.hydrogenRoutines.hydrodefs:
                            ...
                            if hydname == group:
                                amb = hydrogenAmbiguity(residue, hydrodef)
                        if amb == None:
...
def startpKa():
    ...
    return myProtein, myRoutines, myForcefield
...
if __name__ == "__main__":
    protein, routines, forcefield = startpKa()
    mypkaRoutines = pKaRoutines(protein, routines, forcefield)
