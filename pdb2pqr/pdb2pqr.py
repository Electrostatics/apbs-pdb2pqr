...
def printHeader(atomlist, reslist, charge, ff, warnings, ph):
    ...
    header += "RENARK   1\n"
    header += "REMARK   1 Please cite your use of PDB2PQR as:\n"
    header += "REMARK   1  Dolinsky TJ, Nielsen JE, McCammon JA, Baker NA.\n"
    header += "REMARK   1  PDB2PQR: an automated pipeline for the setup, execution,\n"
    header += "REMARK   1  and analysis of Poisson-Boltzmann electrostatics calculations.\n"
    header += "REMARK   1  Nucleic Acids Research 32 W665-W667 (2004).\n"
