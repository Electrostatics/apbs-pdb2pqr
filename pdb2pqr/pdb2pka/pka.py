                ...
                for state in possiblestates:
                    ...
                    if mode=='pKD':
                        ...
                        for atom in self.protein.getAtoms():
                            ...
                            all_potentials[pKa][titration][state][atom_uniqueid]=potentials[count-1]
                            count=count+1
                        import copy
...
def startpKa():
    ...
    print
    shortOptlist = "h,v"
    longOptlist = ["help","verbose","ff=",'lig=',"pdie=",]
    ...
    #
    return pre_init(pdbfilename=path,ff=ff,ligand=ligfilename,pdie=pdie,)
...
def pre_init(pdbfilename=None,ff=None,ligand=None,verbose=1,pdie=None,):
