...
APBS users have several ways to invoke the finite difference solver capabilities of APBS:

\todo{FIX}
APBS users can invoke TABI-PB with the \keyword{bem-manual} flag in the ELEC section of the input file.
